...
|---|---|---|---|---|
| `src/main/java/ch/ti/gagi/xsleditor/ui/AboutDialog.java` | component | request-response | `src/main/java/ch/ti/gagi/xsleditor/ui/SearchDialog.java` | exact |
| `src/main/java/ch/ti/gagi/xsleditor/ui/MainController.java` | controller | request-response | self (existing file, add handler) | exact |
| `src/main/resources/ch/ti/gagi/xsleditor/ui/main.fxml` | config | event-driven | self (existing file, add Menu node) | exact |
| `src/main/java/ch/ti/gagi/xsleditor/XSLEditorApp.java` | config | request-response | self (existing file, expose hostServices) | exact |
...
### `src/main/java/ch/ti/gagi/xsleditor/ui/AboutDialog.java` (component, request-response)

**Analog:** `src/main/java/ch/ti/gagi/xsleditor/ui/SearchDialog.java`
...
### `src/main/java/ch/ti/gagi/xsleditor/ui/MainController.java` — add `handleAbout()` (controller, request-response)
...
**Static HostServices exposure pattern** — add to XSLEditorApp and reference from MainController:
```java
// In XSLEditorApp (static accessor added in this phase):
...
### `src/main/resources/ch/ti/gagi/xsleditor/ui/main.fxml` — add Help menu (config, event-driven)
...
### `src/main/java/ch/ti/gagi/xsleditor/XSLEditorApp.java` — expose hostServices (config, request-response)

**Analog:** self — existing `start()` method (XSLEditorApp.java lines 26-43)

**Existing start() pattern** (XSLEditorApp.java lines 26-43):
```java
@Override
...
**Source:** `src/main/java/ch/ti/gagi/xsleditor/ui/SearchDialog.java` lines 92-95
...
**Source:** `src/main/java/ch/ti/gagi/xsleditor/ui/MainController.java` lines 187-188
...
**Source:** `src/main/java/ch/ti/gagi/xsleditor/ui/MainController.java` lines 230-235
...
**Analog search scope:** `src/main/java/ch/ti/gagi/xsleditor/`, `src/main/resources/`, `build.gradle`
