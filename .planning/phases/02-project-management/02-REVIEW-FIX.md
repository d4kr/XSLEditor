...
**Files modified:** `src/main/java/ch/ti/gagi/xsleditor/render/RenderOrchestrator.java`
**Commit:** 6484a67
...
**Files modified:** `src/main/java/ch/ti/gagi/xsleditor/model/ProjectManager.java`
**Commit:** 7037450
